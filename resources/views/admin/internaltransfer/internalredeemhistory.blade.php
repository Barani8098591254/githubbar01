							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="reedemhistory" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
                                                        <th>Sender</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#reedemhistory').DataTable({
            language: { search: "", searchPlaceholder: "Sender, Reciver, Currency, Amount"},
         ...
         'ajax': {
           'url': base_url+"/getinternalredeemhistory",
           'data': function(data){
              // Read values
         ...
         'columns': [
            ...
            // { data: 'action', class: 'text-center' },
                                             ...
                                             $('#reedemhistory_filter input').attr('data-toggle', 'tooltip');
   $('#reedemhistory_filter input').attr('title', 'Sender, Reciver, Currency, Amount');
   $('#reedemhistory_filter input').tooltip({
