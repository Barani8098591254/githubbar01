						...
						<div class="panel panel-default card-view">
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    ...
                                    <a href="internalredeemhistory"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="internaltransfer" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
                                                        <th>Sender</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#internaltransfer').DataTable({
            language: { search: "", searchPlaceholder: "Currency, Sender, Reciver"},
         ...
         'ajax': {
           'url': base_url+"/getinternaltransferhistory",
           'data': function(data){
              // Read values
         ...
         'columns': [
            ...
            { data: 'toUsername', class: 'text-center' },
            { data: 'symbol', class: 'text-center' },
            { data: 'toAmount', class: 'text-center' },
            { data: 'usdprice', class: 'text-center' },
            { data: 'redeemCode', class: 'text-center' },
            ...
            { data: 'date', class: 'text-center' },
                                             ...
                                             $('#internaltransfer_filter input').attr('data-toggle', 'tooltip');
   $('#internaltransfer_filter input').attr('title', 'Pair Name, Plan Amount,Currency');
   $('#internaltransfer_filter input').tooltip({
