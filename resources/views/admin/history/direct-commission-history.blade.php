						...
						<div class="panel panel-default card-view">
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    ...
                                    <a href="directCommission"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="levelcommission" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>User Name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#levelcommission').DataTable({
        language: { search: "", searchPlaceholder: "User name, From user, Description"},
         'processing': true,
         'serverSide': true,
         'serverMethod': 'post',
         'searching': true, // Set false to Remove default Search Control
         'ajax': {
           'url': base_url+"/getdirectCommission",
           'data': function(data){
              // Read values
         ...
         'columns': [
            ...
            { data: 'from_username', class: 'text-center' },
            ...
            { data: 'date', class: 'text-center' },
                                 ...
                                 $('#levelcommission_filter input').attr('data-toggle', 'tooltip');
   $('#levelcommission_filter input').attr('title', 'User name, From user, Description');
   $('#levelcommission_filter input').tooltip({
