...
<script type="text/javascript">
    ...
    $(document).on("click", ".reason", function() {
      var id = $(this).attr("data-id");
      var reason = $(this).attr("data-reasion");
      $('.withdrawId').val(id);
      $('.reason').val(reason);
    });
    ...
    language: { search: "", searchPlaceholder: "User Name, Currency, Address"},
     ...
     'columns': [
        ...
        { data: 'action', class: 'text-center' },
                                               ...
                                               $('#withdraw_filter input').attr('data-toggle', 'tooltip');
   $('#withdraw_filter input').attr('title', 'Username, Currency, Address');
   $('#withdraw_filter input').tooltip({
