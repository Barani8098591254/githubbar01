        ...
        <div class="panel panel-default card-view">
            ...
            <form id="filter-form" method="GET" action="">
                ...
                &nbsp;
                    ...
                    <a href="userActivity"><button type="button" class="btn btn-danger mt-20 mb-20">
          ...
          <div class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="table-wrap">
                <div class="">
                  <table id="user_Activity" class="table table-hover display  pb-30 user_Activity">
                    <thead>
                      <tr>
                        <th>S.No</th>
                        <th>User name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#user_Activity').DataTable({
        language: { search: "", searchPlaceholder: "User Name, Activity, Broswer"},
         'processing': true,
         'serverSide': true,
         'serverMethod': 'post',
         ...
         'columns': [
            ...
            { data: 'date', class: 'text-center' },
               ...
               $('#user_Activity_filter input').attr('data-toggle', 'tooltip');
   $('#user_Activity_filter input').attr('title', 'Username , Activity, Browser');
   $('#user_Activity_filter input').tooltip({
