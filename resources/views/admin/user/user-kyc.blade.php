					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    <a href="kyc"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="userKycTable" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>User name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#userKycTable').DataTable({
         ...
         'columns': [
            ...
            { data: 'action', class: 'text-center' },
                           ...
                           $('#userKycTable_filter input').attr('data-toggle', 'tooltip');
   $('#userKycTable_filter input').attr('title', 'Username, Email');
   $('#userKycTable_filter input').tooltip({
