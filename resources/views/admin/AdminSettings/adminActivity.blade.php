                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                   <div class="row">
                                    <form id="filter-form" method="GET" action="">
                                        ...
                                        &nbsp;
                                            ...
                                            <a href="adminActivity"><button type="button" class="btn btn-danger mt-20 mb-20">
                                ...
                                <div class="table-wrap">
                                    <div class="">
>
                                        <table id="admin_activitytable" class="table table-hover display  pb-30" >
                                            <thead>
                                                <tr>
                                                    <th>S.No</th>
                                                    <th>Admin name</th>
...
$(document).ready(function(){
   ...
   // DataTable
     var dataTable = $('#admin_activitytable').DataTable({
    language: { search: "", searchPlaceholder: "Activity, Browser"},
     'processing': true,
     'serverSide': true,
     'serverMethod': 'post',
     ...
     'columns': [
        ...
        { data: 'activity', class: 'text-center' },
        { data: 'ip', class: 'text-center' },
        { data: 'browser', class: 'text-center' },
        { data: 'os', class: 'text-center' },
        { data: 'date', class: 'text-center' },
         ...
         $('#admin_activitytable_filter input').attr('data-toggle', 'tooltip');
   $('#admin_activitytable_filter input').attr('title', 'Activity, Browser');
   $('#admin_activitytable_filter input').tooltip({
