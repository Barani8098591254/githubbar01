					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                            ...
                            <div class="mb-20 pl-15" style="float: right;">
                                <a href="{{adminBaseurl()}}addPlan" title="Add Plan" class="btn btn-primary " ><i class="fa fa-plus" aria-hidden="true"></i> Add Plan</a>
                            </div>
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    ...
                                    <a href="planList"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="planlist" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>Plan Name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#planlist').DataTable({
            language: { search: "", searchPlaceholder: "Plan Name, Plan Amount, Currency"},
         ...
         'columns': [
            ...
            { data: 'roi_commission', class: 'text-center' },
            { data: 'direct_commission', class: 'text-center' },
            ...
            { data: 'action', class: 'text-center' },
                                             ...
                                             $('#planlist_filter input').attr('data-toggle', 'tooltip');
   $('#planlist_filter input').attr('title', 'Pair Name, Plan Amount,Currency');
   $('#planlist_filter input').tooltip({
