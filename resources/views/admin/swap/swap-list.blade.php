				...
				<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                            ...
                            <div class="mb-20 pl-15 create-swap">

                                <a href="addswap" class="btn btn-primary"> <i class="icon-plus"></i> Add Swap Pair</a>
                            </div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="swaplist" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>Pair Name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#swaplist').DataTable({
            language: { search: "", searchPlaceholder: "Pair name, From currency, To currency"},
         ...
         'columns': [
            ...
            { data: 'from_currency', class: 'text-center' },
            { data: 'to_currency', class: 'text-center' },
            { data: 'marketprice', class: 'text-center' },
            { data: 'swapstatus', class: 'text-center' },
            ...
            { data: 'action', class: 'text-center' },
                                             ...
                                             $('#swaplist_filter input').attr('data-toggle', 'tooltip');
   $('#swaplist_filter input').attr('title', 'Pair Name, From Currency, To Currency');
   $('#swaplist_filter input').tooltip({
