							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="investment" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>UserName</th>
...
<script>
    function confirmtwithdrawChange(action,msg) {
        let actionText =  msg;
        let confirmMessage = `Are you sure you want to ${actionText} this Cancel ?`;
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#investment').DataTable({
            language: { search: "", searchPlaceholder: "User name, Currency"},
         ...
         'columns': [
            ...
            { data: 'cancel', class: 'text-center' },
                                       ...
                                       $('#investment_filter input').attr('data-toggle', 'tooltip');
   $('#investment_filter input').attr('title', 'User name, Currency');
   $('#investment_filter input').tooltip({
