					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    <a href="pendingkyc"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="inactivekyclist" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>User name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#inactivekyclist').DataTable({
