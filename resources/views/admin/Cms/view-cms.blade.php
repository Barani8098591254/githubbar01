							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="table-wrap">
										<div class="">
											<table id="cmslist" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>Name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#cmslist').DataTable({
            language: { search: "", searchPlaceholder: "Name"},
         ...
         'columns': [
            ...
            { data: 'action', class: 'text-center' },
               ...
               $('#cmslist_filter input').attr('data-toggle', 'tooltip');
   $('#cmslist_filter input').attr('title', 'Enter Name');
   $('#cmslist_filter input').tooltip({
