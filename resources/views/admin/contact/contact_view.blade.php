  ...
  <div class="container-fluid">
    ...
    <div class="row heading-bg">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          <li>
            <a href="{{adminBaseurl()}}support">Dashboard</a>
          </li>
          <li class="active">
            <span>Support</span>
          </li>
        ...
        <div class="panel panel-default card-view">
            ...
            <form id="filter-form" method="GET" action="">
                ...
                &nbsp;
                    ...
                    <a href="support"><button type="button" class="btn btn-danger mt-20 mb-20">
          ...
          <div class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="table-wrap">
                <div class="">
                  <table id="supporttable" class="table table-hover display  pb-30">
                    <thead>
                      <tr>
                        <th>S.No</th>
                        <th>User Name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#supporttable').DataTable({
            language: { search: "", searchPlaceholder: "User Name, Email, Phone"},
         'processing': true,
         'serverSide': true,
         'serverMethod': 'post',
         'searching': true, // Set false to Remove default Search Control
         'ajax': {
           'url': base_url+"/getsupportdata",
           'data': function(data){
              // Read values
         ...
         'columns': [
            ...
            { data: 'action', class: 'text-center' },
                     ...
                     $('#supporttable_filter input').attr('data-toggle', 'tooltip');
   $('#supporttable_filter input').attr('title', 'Username, Email, Phone');
   $('#supporttable_filter input').tooltip({
