					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                            ...
                            <div class="mb-20 pl-15">
                                <a href="CreateCurrency" class="btn btn-primary ">Add Currency</a>
                            </div>
                            ...
                            <form id="filter-form" method="GET" action="">
                                ...
                                &nbsp;
                                    ...
                                    <a href="currencyList"><button type="button" class="btn btn-danger mt-20 mb-20">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
										<div class="">
											<table id="currencylist" class="table table-hover display  pb-30" >
												<thead>
													<tr>
														<th>S.No</th>
														<th>Currency name</th>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#currencylist').DataTable({
        language: { search: "", searchPlaceholder: "Currency Name, Currency Symbol"},
         ...
         'columns': [
            ...
            { data: 'currency_type',class: 'text-center' },
            { data: 'status', class: 'text-center' },
            { data: 'investment_status', class: 'text-center' },
            ...
            { data: 'action', class: 'text-center' },
                     ...
                     $('#currencylist_filter input').attr('data-toggle', 'tooltip');
   $('#currencylist_filter input').attr('title', 'Currency name, Currency symbol');
   $('#currencylist_filter input').tooltip({
