                                        ...
                                        <div class="dashboard-widgett">
                                            ...
                                            <div class="depositcont">
                                                ...
                                                <div class="dashboard-table table-responsive">
                                                    <table id="instantswaphistory" class="" style="width:100%">
                                                        <thead>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#instantswaphistory').DataTable({


        language: { search: "", searchPlaceholder: "Username, Pair, Order Type"},
         ...
         'ajax': {
           'url': base_url+"getInstantSwaphistory",
           'data': function(data){
              // Read values
      ...
      $('#instantswaphistory_filter input').attr('data-toggle', 'tooltip');
   $('#instantswaphistory_filter input').attr('title', 'Username, Pair, Order Type');
   $('#instantswaphistory_filter input').tooltip({
