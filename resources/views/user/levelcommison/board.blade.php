                                        ...
                                        <div class="dashboard-widgett">
                                            ...
                                            <div class="depositcont">
                                                <div class="dashboard-table table-responsive">
                                                 <table id="boardcommission" class="" style="width:100%">
                                                     <thead>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // DataTable
         var dataTable = $('#boardcommission').DataTable({
        ...
        language: { search: "", searchPlaceholder: "Currency, Amount, Description"},
         ...
         'ajax': {
           'url': base_url+"userboardcommisson",
           'data': function(data){
              // Read values
      ...
      $('#boardcommission_filter input').attr('data-toggle', 'tooltip');
   $('#boardcommission_filter input').attr('title', 'Currency, Amount, Description');
   $('#boardcommission_filter input').tooltip({
